		...
		<div class="container">
			<div class="row top-line animate-box">
				<div class="col-md-7 col-md-push-5 text-left intro">
					<h2>หน้าร้านของคุณ <span class="fh5co-highlight">Made with <i class="icon-heart2"></i> by <a href="http://freehtml5.co">FreeHTML5.co</a> </span></h2>
            ...
            <?php while($row=mysqli_fetch_array($query)){ ?>
				<div class="col-md-4 text-center animate-box">
					<a class="work" href="orderdetail.php?name=<?php echo $row["name"];?>">
						<div class="work-grid" style="background-image:url(myfile/<?php echo $row["picture"];?>);">
							<div class="inner">
								<div class="desc">
								<h3><?php echo $row["name"];?></h3>
								<span class="cat">ดูรายละเอียด</span>
							</div>
							</div>
						</div>
					</a>
					...
					<a class="work" href="portfolio_detail.php">
						<div class="work-grid" style="background-image:url(images/project-2.jpg);">
							<div class="inner">
								<div class="desc">
									<h3>Plush</h3>
									<span class="cat">เพิ่มสินค้า</span>
								</div>
							</div>
						</div>
					</a>
